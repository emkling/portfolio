      ...
      <motion.div animate={animation} name='projects' id='projects' className='max-w-[1000px] mx-auto p-4 snap-start' >
        ...
        <motion.section animate={animation} className='max-w-[1000px] h-1/3 m-auto flex align-center rounded-md justify-center'>
          ...
          <div className='w-1/2 flex-col align-even justify-center ml-[-60px] flex z-10'>
             ...
             <a href = "https://github.com/emkling/scheduling-desktop-application" target="_blank" className='flex justify-end pr-2 pt-4 text-gray-300 hover:text-[#D8A31A]' ><FaGithub color='#D8A31A' size={25}/></a>
          </div>
        </motion.section>
