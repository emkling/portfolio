...
const Projects2 = () => {
  ...
  return (
    <div ref={ref} className='w-full sm:h-screen relative text-gray-300 bg-gradient-one z-10'>
        ...
        <motion.section animate={animation} className='max-w-[1000px] sm:h-1/3 m-auto flex align-center rounded-md justify-center'>
          ...
          <div className='w-1/2 flex-col align-even justify-center ml-[-60px] flex z-10'>
             <div className='text-[#B33B3B] pb-4'>
               ...
               <h1 className='text-xl text-left sm:text-right text-gray-300'>Appointment Application</h1>
             </div>
             
             <div className='w-full  glass rounded-md  flex justify-center items-center p-4'>
               <p className='text-left sm:text-right'>Standalone JavaFX application that schedules appointments for a fictional company and directly manipulates customer/scheduling data stored within a remote relational database.  
             ...
             <a href = "https://github.com/emkling/scheduling-desktop-application" target="_blank" className='flex justify-end pr-2 pt-4 text-gray-300 hover:text-[#B33B3B]' ><FaGithub color='#B33B3B' size={25}/></a>
          </div>
        </motion.section>
