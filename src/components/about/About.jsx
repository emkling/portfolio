...
const About = () => {
  ...
  return (
    ...
    <div ref={ref} name='about' id='about' className='w-full relative z-10 sm:h-screen pt-32 sm:pt-0 bg-gradient-one  bg-[#0f0e13] text-gray-300 sm:snap-start overflow-hidden'>
      <div id="wave2">
       <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
        ...
        <div  className='flex flex-col relative justify-center  items-center h-screen z-10 ' >
